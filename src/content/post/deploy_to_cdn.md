...
> 注意：在 LightCDN 的新策略中，不能同时存在相同的来源网站，所以我们需要将 imagekit.io 服务器封装一层。放心，所有的东西都是免费且强大的。[请先查看这里，然后继续](./transport_imagekit)
> 嘟嘟，2024 年 4 月，LightCDN 会针对 Deno Deploy 的服务，然后进行 307 跳转，从而没过 CDN。暂时在找其它方法中。
